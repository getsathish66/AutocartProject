					...
					<form class="form-horizontal" action="newCategory" method="post" onsubmit="return validation()">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="id" id="id"  placeholder="" value="${category.id}" readonly="true"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="categoryName" id="name"  placeholder="" value="${category.categoryName}"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="categoryDescription" id="description"  placeholder="" value="${category.categoryDescription}"/>
								</div>
							</div>
						</div>
